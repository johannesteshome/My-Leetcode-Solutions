...
<pre data-copier-init="true"><strong>Input:</strong> l1 = [2,4,3], l2 = [5,6,4]
...
<pre data-copier-init="true"><strong>Input:</strong> l1 = [0], l2 = [0]
<strong>Output:</strong> [0]
</pre>

<p><strong class="example">Example 3:</strong></p>

<pre data-copier-init="true"><strong>Input:</strong> l1 = [9,9,9,9,9,9,9], l2 = [9,9,9,9]
...
<ul>
	<li>The number of nodes in each linked list is in the range <code data-copier-init="true">[1, 100]</code>.</li>
