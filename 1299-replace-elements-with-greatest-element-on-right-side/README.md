...
<pre data-copier-init="true"><strong>Input:</strong> arr = [17,18,5,4,6,1]
...
<pre data-copier-init="true"><strong>Input:</strong> arr = [400]
...
<ul>
	...
	<li><code data-copier-init="true">1 &lt;= arr[i] &lt;= 10<sup>5</sup></code></li>
</ul>
</div>